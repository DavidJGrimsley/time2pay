...
function parseSession(value: unknown, path: string): Session {
  ...
  return {
    ...
    pr_url: readNullableString(getOptionalField(record, 'pr_url') ?? null, `${path}.pr_url`),
    pr_number: readNullableNumber(getOptionalField(record, 'pr_number') ?? null, `${path}.pr_number`),
